...
useEffect(()=>{
  ...
  return (
    <div className='max-w-7xl mx-auto p-6 '>
      ...
      {productsLoading||ordersLoading ? (<p>Loading ...</p>):productsError?(<p>Error fetching products:{productsError}  ...</p>):ordersError?(<p>Error fetching orders:{ordersError}  ...</p>):(
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="p-4 shadow-md rounded-lg">
            <h2 className="text-xl font-semibold">Reveniue</h2>
