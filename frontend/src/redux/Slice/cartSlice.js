...
// ASYNCTHUNK TO FETCH THE CART FOR A USER AND GUEST 
...
// ASYNCTHUNK TO ADD an item to  THE CART FOR A USER AND GUEST 
...
// ASYNCTHUNK TO UPDATE an item to  THE CART FOR A USER AND GUEST 
...
// ASYNCTHUNK TO REMOVE an item to  THE CART FOR A USER AND GUEST 
...
// ASYNC THUNK FOR MERGE GUEST CART INTO USER CART
...
const cartSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder.addCase(fetchCart.pending, (state) => {
            ...
            state.loading = false;
            state.error = action.payload?.message || "Failed to removr item ";
