    ...
    <footer className='border-t py-12' >
      <div className='container grid mx-auto grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
        <div>
            ...
            {/* Newsletter Form */}
            <form className='flex'>
                <input type="email" placeholder='Enter your email' className='p-3 w-full text-sm border-t border-l border-b text-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all' required />
